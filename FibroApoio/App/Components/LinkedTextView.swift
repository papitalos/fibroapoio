...
struct LinkedTextView_Previews: PreviewProvider {
    static var previews: some View {
        ...
        return VStack {
            LinkedTextView(fullText: fullText, links: links, textStyle: .caption, textColor: .green, linkColor: .red, underlined: false)
                .padding()
            LinkedTextView(fullText: fullText, links: links, textStyle: .body, textColor: .blue, linkColor: .orange, underlined: true)
                .padding()
        }
    }
}
