...
struct ActionableTextView: View {
...
struct ActionableTextView_Previews: PreviewProvider {
    static var previews: some View {
        ...
        return VStack {
            ActionableTextView(fullText: fullText, actions: actions, textStyle: .caption, textColor: .green, actionableTextColor: .red, underlined: false)
                .padding()
            ActionableTextView(fullText: fullText, actions: actions, textStyle: .body, textColor: .blue, actionableTextColor: .orange, underlined: true)
                .padding()
        }
    }
}
